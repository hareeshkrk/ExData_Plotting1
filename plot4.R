...
plot(powerconsumptionsub$Datetime,powerconsumptionsub$Voltage ,xlab = "datetime", ylab = "Voltage",type = "l")
...
plot(powerconsumptionsub$Datetime,powerconsumptionsub$Global_reactive_power ,xlab = "datetime", ylab = "Global_reactive_power",type = "l")
